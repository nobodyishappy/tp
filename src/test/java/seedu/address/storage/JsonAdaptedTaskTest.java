...
public class JsonAdaptedTaskTest {
    ...
    public void toModelType_validTask_success() throws IllegalValueException {
        JsonAdaptedTask jsonAdaptedTask = new JsonAdaptedTask(VALID_NAME, VALID_DESCRIPTION, PRIORITY, STATUS);
    ...
    public void toModelType_emptyName_throwsIllegalValueException() {
        JsonAdaptedTask jsonAdaptedTask = new JsonAdaptedTask(EMPTY_NAME, VALID_DESCRIPTION, PRIORITY, STATUS);
    ...
    public void toModelType_emptyDescription_throwsIllegalValueException() {
        JsonAdaptedTask jsonAdaptedTask = new JsonAdaptedTask(VALID_NAME, EMPTY_DESCRIPTION, PRIORITY, STATUS);
        assertThrows(IllegalValueException.class, jsonAdaptedTask::toModelType);
    }

    @Test
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedTask jsonAdaptedTask = new JsonAdaptedTask(null, VALID_DESCRIPTION, PRIORITY, STATUS);
        assertThrows(IllegalValueException.class, jsonAdaptedTask::toModelType);
    }

    @Test
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedTask jsonAdaptedTask = new JsonAdaptedTask(VALID_NAME, null, PRIORITY, STATUS);
        assertThrows(IllegalValueException.class, jsonAdaptedTask::toModelType);
    }

    @Test
    public void toModelType_nullPriority_throwsIllegalValueException() {
        JsonAdaptedTask jsonAdaptedTask = new JsonAdaptedTask(VALID_NAME, VALID_DESCRIPTION, null, STATUS);
        assertThrows(IllegalValueException.class, jsonAdaptedTask::toModelType);
    }

    @Test
    public void toModelType_nullStatus_throwsIllegalValueException() {
        JsonAdaptedTask jsonAdaptedTask = new JsonAdaptedTask(VALID_NAME, VALID_DESCRIPTION, PRIORITY, null);
        assertThrows(IllegalValueException.class, jsonAdaptedTask::toModelType);
    }
}
